...
class BuildSettingsForm extends FormGroup implements IFormValidated {
    ...
    BuildSettingsForm() {
        ...
        outPath = new LabeledActionInput(title: "Output path:", browseType: BrowseType.DIRECTORY, canBeEmpty: true, shortPathForProject: ModelStorage.instance.project, directoryCanBeEmpty:false)
