...
class Log {
    ...
    private javafx.collections.ObservableList<LogMessage> createTestLogList() {
        FXCollections.observableArrayList(
                new LogMessage("com.codeOrchestra.*:8", Level.WARN, """ListView Selection / Focus APIs To track selection and focus, it is necessary to become familiar with the SelectionModel and
